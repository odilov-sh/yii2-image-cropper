    ...
    $.fn.cropper = function (options, width, height) {
        var $widget = $(this).closest('.cropper-widget'),
            ...
            cropper = {
                ...
                $upload_url: $widget.find('.upload-url-input').val(),
                uploader: null,
                reader: null,
                selectedFile: null,
                init: function () {
                    ...
                    cropper.$widget
                        ...
                        .on('click', '.crop-photo', function () {
                            ...
                            data['oldImage'] = options.oldImage;
                ...
                deleteOldPhotoFromSrc: function () {

                    var $oldImage = cropper.$photo_field.val();
                    var $url = cropper.$upload_url;
